...
The MSEG editor's curve canvas also has a small strip of mode controls (Randomize button, Polarity toggle Unipolar / Bipolar, Play Mode toggle Cyclic / OneShot, Time Grid dropdown, Style dropdown).
